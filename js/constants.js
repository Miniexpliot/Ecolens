...
export const EMISSION_FACTORS = {
  ...
  home: {
    heatingCooling: { // tons CO2e per year
      heavy: 2.5,
      moderate: 1.5,
      minimal: 0.8,
      none: 0.3
    },
    appliances: { // tons CO2e per year
      neverUnplug: 0.8,
      sometimesUnplug: 0.5,
      alwaysUnplug: 0.3
    },
    renewableFactor: { // multiplier applied to home total
      none: 1.0,
      partial: 0.5,
      full: 0.1
    }
  },
  diet: { // tons CO2e per year
    meatConsumption: {
      daily: 3.3,
...
export const ACTION_ITEMS = [
  // ── TRAVEL actions ──────────────────────────────────────────────────────
  {
    ...
    description: 'Hybrid cars produce ~45% less emissions than gasoline vehicles per mile driven.',
    baseSavingsKg: 460,
  ...
  },
  {
    ...
    description: 'EVs produce ~76% less emissions than gas cars, even accounting for grid electricity.',
    baseSavingsKg: 780,
    condition: (inputs) => inputs.travel.carType === 'gas' || inputs.travel.carType === 'hybrid'
  },
  {
    id: 'carpool',
    category: 'travel',
    title: 'Carpool 3 Days per Week',
    description: 'Sharing rides cuts your per-person travel emissions roughly in half on carpool days.',
    baseSavingsKg: 520,
    condition: (inputs) => inputs.travel.carType !== 'none' && inputs.travel.commuteDistance > 5
  },
  {
    id: 'public-transit',
    category: 'travel',
    title: 'Take Public Transit Twice a Week',
    description: 'Buses and trains produce a fraction of per-passenger emissions compared to solo driving.',
    baseSavingsKg: 680,
    condition: (inputs) => inputs.travel.carType !== 'none' && inputs.travel.transitFrequency < 3
  },
  {
    id: 'bike-short-trips',
    category: 'travel',
    title: 'Bike or Walk for Short Trips',
    description: 'Replace car trips under 3 miles with walking or cycling for zero-emission travel.',
    baseSavingsKg: 320,
  ...
  // ── HOME actions ────────────────────────────────────────────────────────
  {
    ...
    description: 'Each degree adjustment saves ~3% on heating/cooling energy bills and emissions.',
    baseSavingsKg: 300,
    condition: (inputs) => inputs.home.heatingCooling !== 'none' && inputs.home.heatingCooling !== 'minimal'
  },
  {
    id: 'led-bulbs',
    category: 'home',
  ...
  },
  {
    ...
    description: 'Phantom power from idle electronics accounts for 5-10% of residential energy use.',
    baseSavingsKg: 300,
  ...
  },
  {
    ...
    description: 'Green energy tariffs can reduce your home electricity emissions by up to 90%.',
    baseSavingsKg: 1500,
  ...
  },
  {
    ...
    description: 'Smart thermostats learn your schedule and can save 10-15% on heating and cooling.',
    baseSavingsKg: 500,
  ...
  },
  {
    ...
    description: 'Dryers are one of the most energy-intensive home appliances. Air-drying saves significant energy.',
    baseSavingsKg: 200,
    condition: () => true
  },
  ...
  // ── DIET actions ────────────────────────────────────────────────────────
  {
    ...
    description: 'Beef production generates 60kg CO2e per kg — 20x more than legumes.',
    baseSavingsKg: 800,
    condition: (inputs) => inputs.diet.meatConsumption === 'daily' || inputs.diet.meatConsumption === 'frequently'
  },
  {
    id: 'go-vegetarian',
    category: 'diet',
    title: 'Try a Vegetarian Diet',
    description: 'Eliminating meat entirely can reduce your food carbon footprint by over 50%.',
    baseSavingsKg: 1200,
    condition: (inputs) => inputs.diet.meatConsumption !== 'vegetarian' && inputs.diet.meatConsumption !== 'vegan'
  },
  {
    id: 'buy-local',
    category: 'diet',
    title: 'Buy Local & Seasonal Produce',
    description: 'Locally-sourced food travels fewer miles, reducing transportation emissions.',
    baseSavingsKg: 300,
    condition: () => true
  },
  {
    ...
    description: 'The average person wastes ~200 lbs of food/year. Reducing waste cuts methane from landfills.',
    baseSavingsKg: 300,
    condition: () => true
  },
  {
    ...
    description: 'Proper recycling diverts waste from landfills and reduces raw material extraction emissions.',
    baseSavingsKg: 300,
  ...
  },
  {
    ...
    description: 'Composting prevents methane emissions from food decomposing in landfills.',
    baseSavingsKg: 200,
  ...
  // ── SHOPPING actions ────────────────────────────────────────────────────
  {
    ...
    description: 'The fashion industry accounts for ~10% of global emissions. Secondhand extends garment life.',
    baseSavingsKg: 500,
    condition: (inputs) => inputs.shopping.fastFashion !== 'secondhand' && inputs.shopping.fastFashion !== 'minimal'
  },
  {
    id: 'reduce-plastics',
    category: 'shopping',
    title: 'Eliminate Single-Use Plastics',
    description: 'Reusable bags, bottles, and containers reduce petroleum-based plastic production emissions.',
    baseSavingsKg: 100,
    condition: () => true
  }
];
